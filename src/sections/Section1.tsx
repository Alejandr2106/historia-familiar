  ...
  return (
    <section id="inicio" className="relative bg-white text-gray-800 overflow-hidden">
      ...
      <div className="relative h-[90vh] flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        {/* Nota principal (derecha) */}
        <div className="absolute bottom-6 right-8 bg-gradient-to-r from-black/60 via-black/40 to-transparent backdrop-blur-sm text-white/95 text-xs italic px-4 py-2 rounded-lg shadow-md text-right max-w-[420px] whitespace-nowrap border border-white/10">
        Escuela de monjas situada en el parque principal de <span className="font-semibold text-white">Monguí.</span>
        </div>
        ...
        >
          ...
          />
          <p className="mt-2 text-[11px] text-white/90 italic text-left pl-1 bg-black/40 backdrop-blur-sm inline-block px-3 py-1 rounded-md shadow-md max-w-[340px]">
      ...
      {/* ==========================
          CUERPO DE TEXTO con fondo visual
      =========================== */}
